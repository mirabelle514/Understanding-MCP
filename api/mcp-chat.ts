...
CHATGPT SUPPORT:
Yes! OpenAI launched Developer Mode in ChatGPT (currently in beta) which provides full MCP client support. You can connect MCP servers to ChatGPT to extend its capabilities.
